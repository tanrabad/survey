...
import org.tanrabad.survey.presenter.*;
import org.tanrabad.survey.presenter.view.EditTextStepperTest;
import org.tanrabad.survey.presenter.view.TorchButtonTest;
...
@Suite.SuiteClasses({
        ...
        SurveyBuildingHistoryActivityTest.class,

        EditTextStepperTest.class,
        TorchButtonTest.class,
        AccountUtilsInstrumentalTest.class
        })
