...
/*                oneOf(filterBoundaryCalculate).getMinLocation(with(currentLocation), with(distanceInKm));
                ...
                oneOf(placeRepository).findTrimmedInBoundaryLocation(insideMinimumLocation,
                        outsideMinimumLocation,
                        insideMaximumLocation,
                        outsideMaximumLocation);
                will(returnValue(locationEntities));
                oneOf(distanceSorter).sort(locationEntities);
