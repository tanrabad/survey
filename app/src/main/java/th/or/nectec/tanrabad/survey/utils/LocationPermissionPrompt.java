...
public class LocationPermissionPrompt {
    ...
    public static void show(final Activity activity) {
        if (!ActivityCompat.shouldShowRequestPermissionRationale(activity,
            ...
            promptMessage.setOnConfirm(activity.getResources().getString(R.string.ok), new PromptMessage.OnConfirmListener() {
                @Override
            ...
            promptMessage.setOnCancel(activity.getResources().getString(R.string.cancel), new PromptMessage.OnCancelListener() {
                @Override
